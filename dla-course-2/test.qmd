...
title: "Test"
course-page: test
course-intro: "Challenge the self-consumption assumption and see when the preferred proposal changes."
...
:::: message
::: meta
13:15 · Thandi Jacobs · Production Manager
:::
...
::: page-visual
![The crossover makes the utilisation assumption material to the decision.](assets/04_sensitivity_crossover.png){fig-alt="Proposal B NPV stays near R2.662 million. Proposal C NPV rises with self-consumption and overtakes B at about 74%. The scenario values are listed in the table above."}
:::
...
::: {#cross-feedback .formative hidden="" role="status"}
:::
::::
