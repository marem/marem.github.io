...
title: "Build"
course-page: build
course-intro: "Turn supplier data into comparable savings, payback and a clear management chart."
...
::: page-visual
![Move from traceable inputs to a qualified management recommendation.](assets/05_evidence_to_decision.png){fig-alt="Supplier data and assumptions feed the model, sensitivity tests, trade-off judgement and a recommendation of no more than 100 words."}
:::
