---
title: "Understand"
course-page: understand
course-intro: "Read the proposals and connect solar generation to economic value."
...
::: {#prediction-status .small-note role="status" data-storage-note=""}
...
::: page-visual
![Higher cost and generation do not automatically mean a better investment.](assets/02_proposals_comparison.png){fig-alt="Installed costs: A R650,000, B R820,000, C R990,000. Generation increases from A to C, while self-consumption falls from 90% to 78%."}
:::
