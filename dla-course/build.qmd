...
![](assets/05_evidence_to_decision.png){.learning-asset fig-alt="Flow from inputs through modelling and sensitivity testing to managerial judgement and recommendation"}
...
[Next: 03 · Test →](test.qmd){.course-button}
:::
